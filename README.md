...
5. `nx r ${packages-name:commands}` Use commands for packages from:
   ...
   2. packages/react-app/project.json
   3. packages/ui-kit/project.json

# NxTsViteReactGraphqlStyledMonorepoExample
...
Libraries are shareable across libraries and applications. They can be imported from `@nx-ts-vite-react-graphql-styled-monorepo-example/mylib`.
