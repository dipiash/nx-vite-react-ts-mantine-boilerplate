...
const SvgFavicon = (properties: SVGProps<SVGSVGElement>) => (
  <svg width="1em" fill="none" height="1em" viewBox="0 0 410 404" xmlns="http://www.w3.org/2000/svg" {...properties}>
    <path
    ...
    />
    <defs>
      <linearGradient id="favicon_svg__a" gradientUnits="userSpaceOnUse" x1={6} x2={235} y1={33} y2={344}>
        <stop stopColor="#41D1FF" />
        <stop offset={1} stopColor="#BD34FE" />
      </linearGradient>
      <linearGradient id="favicon_svg__b" gradientUnits="userSpaceOnUse" x1={194.651} x2={236.076} y1={8.818} y2={292.989}>
