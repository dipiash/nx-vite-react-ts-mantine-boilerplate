...
const SvgFavicon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={410} height={404} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
    ...
    />
    <defs>
      <linearGradient id="favicon_svg__a" x1={6} y1={33} x2={235} y2={344} gradientUnits="userSpaceOnUse">
        <stop stopColor="#41D1FF" />
        <stop offset={1} stopColor="#BD34FE" />
      </linearGradient>
      <linearGradient id="favicon_svg__b" x1={194.651} y1={8.818} x2={236.076} y2={292.989} gradientUnits="userSpaceOnUse">
