...
const result: PossibleTypesResultData = {
  possibleTypes: {
    ...
    SearchResultItem: ['App', 'Discussion', 'Issue', 'MarketplaceListing', 'Organization', 'PullRequest', 'Repository', 'User'],
    ...
    TopicAuditEntryData: ['RepoAddTopicAuditEntry', 'RepoRemoveTopicAuditEntry'],
