...
export type ListRepositoriesQuery = { __typename?: 'Query', search: { __typename?: 'SearchResultItemConnection', repositoryCount: number, edges?: Array<{ __typename?: 'SearchResultItemEdge', cursor: string, node?: { __typename?: 'App' } | { __typename?: 'Discussion' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest' } | { __typename?: 'Repository', createdAt: any, id: string, name: string, updatedAt: any, licenseInfo?: { __typename?: 'License', id: string, name: string } | null, stargazers: { __typename?: 'StargazerConnection', totalCount: number } } | { __typename?: 'User' } | null } | null> | null, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } };

export type GetListLicensesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetListLicensesQuery = { __typename?: 'Query', licenses: Array<{ __typename?: 'License', id: string, key: string, name: string } | null> };
 ...
 *      cursorBefore: // value for 'cursorBefore'
...
export const GetListLicensesDocument = gql`
...
/**
 * __useGetListLicensesQuery__
 *
 * To run a query within a React component, call `useGetListLicensesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetListLicensesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetListLicensesQuery(baseOptions?: Apollo.QueryHookOptions<GetListLicensesQuery, GetListLicensesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetListLicensesQuery, GetListLicensesQueryVariables>(GetListLicensesDocument, options);
      }
export function useGetListLicensesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetListLicensesQuery, GetListLicensesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetListLicensesQuery, GetListLicensesQueryVariables>(GetListLicensesDocument, options);
        }
export type GetListLicensesQueryHookResult = ReturnType<typeof useGetListLicensesQuery>;
export type GetListLicensesLazyQueryHookResult = ReturnType<typeof useGetListLicensesLazyQuery>;
export type GetListLicensesQueryResult = Apollo.QueryResult<GetListLicensesQuery, GetListLicensesQueryVariables>;