...
export type ListLicensesQueryVariables = Exact<{ [key: string]: never; }>;


export type ListLicensesQuery = { __typename?: 'Query', licenses: Array<{ __typename?: 'License', id: string, key: string, name: string } | null> };
...
/**
 * __useListLicensesQuery__
 *
 * To run a query within a React component, call `useListLicensesQuery` and pass it any options that fit your needs.
 * When your component renders, `useListLicensesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useListLicensesQuery(baseOptions?: Apollo.QueryHookOptions<ListLicensesQuery, ListLicensesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ListLicensesQuery, ListLicensesQueryVariables>(ListLicensesDocument, options);
      }
export function useListLicensesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListLicensesQuery, ListLicensesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ListLicensesQuery, ListLicensesQueryVariables>(ListLicensesDocument, options);
        }
export type ListLicensesQueryHookResult = ReturnType<typeof useListLicensesQuery>;
export type ListLicensesLazyQueryHookResult = ReturnType<typeof useListLicensesLazyQuery>;
export type ListLicensesQueryResult = Apollo.QueryResult<ListLicensesQuery, ListLicensesQueryVariables>;
